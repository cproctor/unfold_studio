// InkProject manages files on disk. It won't be of value for me. 
    ...
    if( this.hasUnsavedChanges ) {
        dialog.showMessageBox(remote.getCurrentWindow(), {
            ...
            // Cancel
                ...
                // EVENT ipc.send("project-cancelled-close");
            }
        });
    } 
...
InkProject.prototype.closeImmediate = function() {
    // EVENT ipc.send("project-final-close");
}
