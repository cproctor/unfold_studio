...
urlpatterns = [
    ...
    url(r'stories/(?P<pk>\d+)/history/?$', views.StoryVersionListView.as_view(), name="show_story_versions"), 
    url(r'stories/(?P<pk>\d+)/history/(?P<version>\d+)/?$', views.StoryVersionDetailView.as_view(), 
    ...
    url(r'stories/(?P<pk>\d+)/love/?$', views.LoveStoryView.as_view(), name="love_story"), 
    url(r'stories/(?P<pk>\d+)/fork/?$', views.ForkStoryView.as_view(), name="fork_story"), 
    url(r'stories/(?P<pk>\d+)/share/?$', views.ShareStoryView.as_view(), name="share_story"), 
    url(r'stories/(?P<pk>\d+)/unshare/?$', views.UnshareStoryView.as_view(), name="unshare_story"), 
    url(r'stories/(?P<pk>\d+)/version/?$', views.NewStoryVersionView.as_view(), name="new_story_version"), 
    url(r'stories/(?P<pk>\d+)/delete/?$', views.DeleteStoryView.as_view(), name="delete_story"), 
